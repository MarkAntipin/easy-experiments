...
#[tokio::test]
async fn delete_experiment_draft_ok() {
    // arrange
...
#[tokio::test]
async fn delete_experiment_running_conflict() {
    // arrange
    let app = TestApp::spawn().await;
...
#[tokio::test]
async fn delete_experiment_unknown_id_not_found() {
    // arrange
    let app = TestApp::spawn().await;
...
#[tokio::test]
async fn delete_experiment_malformed_id_validation_error() {
    // arrange
    let app = TestApp::spawn().await;
...
#[tokio::test]
async fn delete_experiment_stopped_ok() {
    // arrange
    let app = TestApp::spawn().await;
    let id = app
...
#[tokio::test]
async fn delete_experiment_other_tenant_not_found() {
...
#[tokio::test]
async fn delete_experiment_already_deleted_not_found() {
    // arrange
    let app = TestApp::spawn().await;
